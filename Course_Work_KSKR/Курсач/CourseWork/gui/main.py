...
default_bracket = [[500, 500], [1100, 500], [1400, 800], [1100, 1100], [500, 1100], [200, 800]]
default_bracket2 = [[500, 800], [800, 500], [1100, 800], [800, 800], [1100, 800]]
...
class MainWindow(QMainWindow):
    ...
    def calculate(self, p):
        if self.data.is_prepared():
            ...
            m = max(moving)
            self.ui.resultText.setText(f"""Рассчитанные значения\n Перемещение макс: {m},\n Деформация макс: {m * 0.000838}\n""")  #Напряжение макс: {m * 92399193}""")
